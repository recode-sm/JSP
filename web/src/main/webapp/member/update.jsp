...
<input type="text" name="postcode" id="postcode" value="<%=memberDTO.getPostcode()%>" readonly><br>
<input type="text" name="address2" id="address2" value="<%=memberDTO.getAddress2() %>" size="35" readonly><br>
</div>
